...
- When executing or describing coding, Git, terminal, or tooling actions, add a short Korean explanation in parentheses for the user.
...
- Use Vercel only for this portfolio. After portfolio edits, deploy the site from `sites/saint-portfolio/` and report the production URL.
